...
_DOMAIN_TOOL_MAP = {
    ...
    "notes_calendar_tasks": {"manage_notes", "manage_calendar", "manage_tasks", "run_workflow"},
    "ui": {"ui_control"},
...
```
Or reference either/both images by filesystem path or bare filename instead of an upload id:
```face_swap
...
Blocked paths/routes (refused for safety): /api/auth/, /api/users/, /api/tokens/, /api/admin/, /api/shell/, /api/import, /api/export, /api/email/accounts, POST /api/cookbook/packages/install, POST /api/cookbook/rebuild-engine, POST /api/cookbook/kill-pid.""",
}
...
_ADMIN_SCHEMA_NAMES = frozenset([
    "manage_session", "manage_skills", "manage_tasks", "run_workflow",
