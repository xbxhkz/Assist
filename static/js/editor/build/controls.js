  ...
  return `
    ...
    <div class="ge-faceswap-section" id="ge-faceswap-section" style="display:none;">
      ...
      <div class="ge-control-row ge-actions" style="flex-wrap:wrap;">
        ...
        <span id="ge-faceswap-filename" style="font-size:10px;opacity:0.6;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:160px;"></span>
      </div>
      <div id="ge-faceswap-preview-wrap" style="display:none;margin-top:6px;">
        <img id="ge-faceswap-preview" alt="Source face preview" style="max-width:100%;max-height:120px;border-radius:6px;display:block;" />
      </div>
      <div class="ge-control-row ge-actions" style="margin-top:6px;">
        <button class="ge-btn ge-btn-primary ge-btn-ai" id="ge-faceswap-run" disabled>
          <span class="ge-btn-ai-mark" aria-hidden="true">✦</span>
          Swap Face
        </button>
      </div>
