...
export function buildToolbar({ currentTool, onSelectTool, onClearSelection }) {
  ...
  const tools = [
    ...
    { id: 'faceswap', ai: true, label: 'Face Swap', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="M16 21l4-4-4-4"/><path d="M20 17H4"/></svg>' },
  ];
  const toolKeyMap = {};
